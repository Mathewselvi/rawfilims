            ...
            <div className="grid-cards">
                {works.map(work => (
                    <div key={work._id} className="card">
                        {work.type === 'video' ? (
                            <video src={getImageUrl(work.imageUrl)} className="card-media" />
                        ) : (
                            <img src={getImageUrl(work.imageUrl)} alt={work.title} className="card-media" />
                        )}
...
const SiteImagesManager = () => {
    ...
    const getImage = (name) => {
        ...
        return s ? getImageUrl(s.imageUrl) : null;
    };
